...
const SolwayAssociation = () => {
  ...
  {/* Left Dots */}
  <img
    src="/src/assets/icons/shapeleft.png"
    alt="dots left"
    className="hidden lg:block absolute left-0 top-1/3 object-cover "
  />
  ...
  <img
    ...
    alt="dots right"
    className="hidden lg:block absolute right-0 top-1/3 object-cover rotate-180 z-0"
  />
...
{/* second one */}
  ...
  <img
    src="/src/assets/icons/shapeleft.png"
    alt="dots left"
    className="hidden lg:block absolute left-0 lg:top-1/2 xl:top-3/4 xl:mt-24 object-cover  "
  />
  ...
  <img
    src="/src/assets/icons/frameright.png"
    alt="dots right"
    className="hidden lg:block absolute right-0 lg:top-1/2 xl:top-3/4 xl:mt-24 object-cover rotate-180 z-0"
  />
   <div className="relative z-10">
       <EngagementSection/>
       </div>
...
{/* ---------------------------------------------------------------------- */}
  ...
  <img
    src="/src/assets/icons/frameright.png"
    alt="dots right"
    className="hidden lg:block absolute right-0 -top-1/6 mt-20 object-cover rotate-180 z-0"
  />
  <div className="relative z-10">
       <GreenSection/>
       </div>
