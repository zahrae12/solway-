  ...
  return (
    <section className="w-full bg-gray-100 py-12 ">
      <div className="w-full p-12 mx-auto">
        <h2 className="text-center font-bold text-yellow-500  uppercase lg:-mt-4 -mt-14">Introducing</h2>
        ...
        {/* About Section */}
        <div className="bg-white shadow-lg p-6 rounded-3xl mt-6">
          <h2 className="text-2xl font-extrabold text-gray-800 font-inter leading-[40px]">
            About SOLWAY Consulting & Services
          </h2>
          <p className="mt-6 text-xl font-inter font-normal text-gray-700 pt-4 lg:pt-0">
          Fondée en octobre 2019, SOLWAY Consulting & Services a pour vocation de vous accompagner en mettant à votre disposition son expertise pointue dans la gestion des ressources humaines via les solutions SAP HR (HCM). Grâce à notre équipe de consultants expérimentés, nous vous offrons un conseil personnalisé pour optimiser la gestion de votre capital humain et la performance de vos processus RH.<br/><br/>
          Notre engagement envers l’excellence, la rigueur et l’innovation nous permet de vous proposer des solutions adaptées à vos besoins spécifiques, tout en prenant en compte les défis uniques de votre organisation. Nous plaçons la satisfaction de nos clients au cœur de notre approche, en établissant une relation de partenariat durable et en garantissant la mise en œuvre efficace de vos projets SAP HR.<br/><br/>
          Avec SOLWAY Consulting & Services, vous bénéficiez d’un accompagnement sur mesure et d’une expertise reconnue pour réussir la transformation de vos processus RH et atteindre vos objectifs d’efficacité et de performance<br/>
          </p>
        ...
        {/* Founder Section */}
          ...
          <h2 className="text-2xl font-extrabold font-inter text-[24px] leading-[32px] text-gray-800 lg:pt-4 pt-16">Fondateur de SOLWAY Consulting & Services</h2>
          <img src="src/assets/images/ceo.png" alt="Amine Hbibiy" className="lg:w-full lg:h-auto  h-[219px]  mt-4 pt-6 lg:pt-0 " />
        ...
        {/* SAP Partnership Section */}
          ...
          <div className="flex justify-center mt-4">
            ...
            className="w-[400px] h-[236px] shadow-lg mt-12 lg:mt-0"
            />
          </div>
          ...
          <br/>
          <br/>
          Notre connaissance approfondie du progiciel SAP et le développement des outils reconnus par SAP, a permit à SOLWAY de devenir un partenaire Silver SAP.
          </p>
          </div>
      </div>
    </section>
