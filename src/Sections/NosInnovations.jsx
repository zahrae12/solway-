...
const NosInnovations = () => {
  return (
    <section className="py-10 -mt-24 px-4 md:px-10 lg:px-20">
      {/* Title Section */}
  ...
  <button className="border border-gray-300 text-black py-2 px-6 md:px-10 rounded-lg font-semibold w-full md:w-auto flex-grow text-center">
    SOLWAY Synchronisation HR
      ...
      {/* Content Section */}
      <div className="flex flex-col md:flex-row bg-white p-6 rounded-2xl shadow-lg gap-6 md:gap-10 mt-16">
        ...
        <div className="w-full md:w-1/2 flex justify-center">
          <img
            className="w-full h-auto bg-gray-200 rounded-2xl"
