...
const Partenaires = () => {
  return (
    <section className=" flex justify-center items-center py-6 -mt-32">
  <div className="max-w-5xl w-full flex flex-col lg:flex-row items-center lg:items-center gap-6 lg:gap-20 justify-center">
