...
const Functionnalities = () => {
  return (
     <section className=" xl:-mt-24 mt-2 ">
       ...
       {/* Main Content */}
       <main className="w-auto xl:p-4 lg:pt-20 pt-40 bg-white shmiow-lg px-4 rounded-xl max-w-8xl mx-auto h-auto">
         {/* Section 1: Écran d'accueil */}
         <section className="grid md:grid-cols-2 gap-8 items-center text-center lg:text-left">
           <div className=''>
             <h2 className="lg:text-[30px] text-[36px] font-bold xl:-mt-16 lg:-mt-12 -mt-32 text-center lg:text-left">Administration du personnel</h2>
        ...
        <li>Diversité des Types d’Absences</li>
         ...
         <section className="grid md:grid-cols-2 xl:pt-8 lg:pt-12 pt-14 items-center lg:gap-4 xl:gap-0">
           <div>
             <h2 className=" text-[32px] font-bold text-center lg:text-left  mt-6 mb-8">Gestion du temps</h2>
             ...
             <ul className="list-disc pl-5  text-gray-750 ">
        ...
        <li>Planification et Gestion des Horaires</li>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 pt-10 pb-12 ">
           <div className="lg:order-1 order-none xl:mt-14 lg:mt-4 ">
             <h2 className=" text-[32px] font-bold text-center lg:text-left">Gestion de la paie</h2>
