  ...
  return (
    <section className="  md:pt-20 flex justify-center items-center lg:px-9 xl:px-12 md:px-4  pt-12">
      ...
      <div className="flex-1 max-w-xl text-center">
        <h1 className="text-[46px] font-extrabold font-inter uppercase text-gray-900">{t("SOLWAY HR")}</h1>
        <p className="text-gray-950 font-inter mt-2 pb-8 text-[16px]">
       {t("SOLWAY HR est une solution intuitive et complète conçue pour optimiser les différents processus des ressources humaines. Notre plateforme offre une gamme étendue de fonctionnalités, couvrant tous les aspects nécessaires et suffisants pour une gestion efficace des ressources humaines")}
        </p>
      </div>
