...
const VerifidsnPlusFooter = () => {
  return (
    <footer className="text-gray-700 md:px-6 px-4 py-4 pt-8">
    <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 text-sm md:-mt-4 xl:mt-0">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:space-x-4 w-full text-center md:text-left lg:text-base">
        ...
        {/* Links */}
        <div className="flex flex-wrap justify-center md:justify-start md:space-x-1 space-x-2 mt-2">
      ...
      <div className="flex flex-col items-center md:flex-row md:space-x-4 mt-4 md:mt-0 space-y-4 md:space-y-0 md:ml-2">
        ...
        {/* Language Button */}
        <button className="border border-yellow-600 text-yellow-600 px-6 py-2 rounded-md hover:bg-yellow-600 hover:text-white transition w-full md:w-auto text-center">
          English
        </button>
      </div>
    </div>
